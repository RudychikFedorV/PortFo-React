  ...
  return (
    <section className="price">
      <div className="container">
        <div className="title price__title">Price plans</div>
        <div className="desc price__desc">
        ...
        <div className="price__list">
          ...
          <div className="price__item">
            ...
            <div className="price__item-desc">
              For most businesses that want to optimize web queries
            </div>
            <div className="price__item-ui position">
              <div className="price__item-svg">
                <img src="/public/assets/Price/сheck+.svg" alt="сheck" />
              </div>
            ...
            <div className="price__item-logo position">
              <div className="price__item-svg">
                <img src="/public/assets/Price/сlose-.svg" alt="сlose" />
              </div>
